...
class _SearchScreenState extends State<SearchScreen> {
                ...
                children: [
                  ...
                  Stack(
                    children: [
                      ...
                      Center(
                        child: Text("Set Drop Off", style: TextStyle(fontSize: 38.0, fontFamily: "Brand Bold"),),
  ...
  void findPlace(String placeName) async{
    if(placeName.length > 1){
      String autoCompleteUrl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=$mapKey&sessiontoken=1234567890&components=country:UGA";
...
class PredictionTile extends StatelessWidget {
  ...
  void getPlaceAddressDetails(String placeId, context) async
  {
    showDialog(
        context: context,
        builder: (BuildContext contex) => ProgressDialog(message: "Setting Drop Off, Please wait...",)
